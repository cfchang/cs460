...
<%   
	   ...
	   // Check the the album name whether it does not exist (11/1/2015)
	   boolean success0 = newAlbumDao1.validAlbum(albName, userID);
	   ...
	   if (!success0) {
	       ...
	       if (success1 && success2) showForm = false;
	       else err = "Couldn't create album";
	    }
       	   else  err = "Couldn't create album (name might exist)";
       	   // End of updates (11/1/2015)
       }
