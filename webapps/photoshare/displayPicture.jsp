...
%>
	    ...
	    <!-- add new code to add the like tag to the picture (11/1/2015) -->
	    <!-- <h4>I <a href="liketag.jsp?picture_id=<%=pid%>">like </a> this picture (Add new tag)</h4> -->
	    <h4>I <a href="likestable.jsp?picture_id=<%=pid%>">like </a> this picture (Add to likes table)</h4>
<%	} %>
...
<table>
	...
	%>
            <tr>
       		<td><p><%=tempText%> (left at <%=tempDate%>)</p></td>
            </tr>
            <tr><prep>
