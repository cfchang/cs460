...
<form action="/photoshare/createnewalbum.jsp?NewAlbumName=" target="_self" method="get">
...
<form action="/photoshare/deletealbum.jsp?deleteAlbumName=" target="_self" method="get">
...
<form action="/photoshare/uploadpicture.jsp?upLoadPicAlbumName=" target="_self" method="get">
 Album Name: <input type="text" name="upLoadPicAlbumName"/>
       	<input type="submit" value="Go"/><br/>
</form>

<form action="/photoshare/listallalbums.jsp" target="_self"> 
